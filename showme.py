...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.search_btn, self.down_btn)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "망가쇼미 만화 수집기 Ver 0.1"))
        self.label.setText(_translate("MainWindow", "MangaShowMe Collector"))
        self.label_2.setText(_translate("MainWindow", "Author: IML\n"
"email: shin10256@gmail.com\n"
"git: github.com\n/iml1111/MangaShowMe_Collector"))
        self.search_bar.setPlaceholderText(_translate("MainWindow", "원하는 만화의 URL을 입력해주세요!"))
